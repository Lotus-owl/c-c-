...
int main(void)
{
	...
	i = 2;
	insertFirstNode(&list1, &i);		//[2, 4]
	i = 1;
	insertFirstNode(&list1, &i);		//[1, 2, 4]
	...
	i = 2;
	deleteNode(&list1, &i);			//[1, 3, 4]
	printList(&list1, printInt);
	
	double d = 4.4;
	insertFirstNode(&list2, &d);		//[4.4]
	d = 2.2;
	insertFirstNode(&list2, &d);		//[2.2, 4.4]
	d = 1.1;
	insertFirstNode(&list2, &d);		//[1.1, 2.2, 4.4]
	...
	d = 2.2;
	deleteNode(&list2, &d);			//[1.1, 3.3, 4.4]
